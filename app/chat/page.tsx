  ...
  return (
    <div className="flex flex-col h-screen bg-[#F7F8FA]">
      ...
      <div className="flex h-[calc(100vh-3.5rem)] mt-14">
        <div className={`${isSidebarCollapsed ? 'w-0 overflow-hidden' : 'w-64'} bg-white border-r transition-all duration-300 flex flex-col relative`}>
          <button 
              ...
              <div key={index} className="mb-6">
                <div className={`max-w-[90%] ${
                  ...
                  <div className={`rounded-2xl p-4 ${
                    msg.role === 'user' 
                      ? 'bg-[#2A63F3]/90 text-white backdrop-blur-sm'
