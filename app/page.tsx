    ...
    <div className="min-h-screen bg-gradient-to-b from-white to-gray-50">
      ...
      <header className="fixed top-0 left-0 right-0 bg-white/80 backdrop-blur-md border-b z-50">
        <div className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            <a href="#features" className="text-gray-600 hover:text-green-600">功能</a>
            <a href="#pricing" className="text-gray-600 hover:text-green-600">价格</a>
            <a href="#faq" className="text-gray-600 hover:text-green-600">常见问题</a>
          </nav>
          <div className="flex items-center space-x-4">
            <button className="px-4 py-2 text-green-600 hover:text-green-700">登录</button>
            <button className="px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700">注册</button>
          </div>
        </div>
      </header>
      ...
      <div className="max-w-4xl mx-auto pt-32 px-4">
        <h1 className="text-5xl font-bold text-center mb-4">
          Chat with any <span className="bg-green-600 text-white px-2 rounded">PDF</span>
        </h1>
      ...
      <footer className="bg-gray-50 text-gray-600 py-12">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              <h3 className="text-gray-900 font-bold mb-4">PDF Chat</h3>
              <p className="text-sm">智能 PDF 阅读助手，让文档交互更简单。</p>
            </div>
            <div>
              <h4 className="text-gray-900 font-semibold mb-4">产品</h4>
              <ul className="space-y-2 text-sm">
                <li><a href="#" className="hover:text-green-600">功能</a></li>
                <li><a href="#" className="hover:text-green-600">价格</a></li>
                <li><a href="#" className="hover:text-green-600">企业版</a></li>
              </ul>
            </div>
            <div>
              <h4 className="text-gray-900 font-semibold mb-4">支持</h4>
              <ul className="space-y-2 text-sm">
                <li><a href="#" className="hover:text-green-600">帮助中心</a></li>
                <li><a href="#" className="hover:text-green-600">API 文档</a></li>
                <li><a href="#" className="hover:text-green-600">联系我们</a></li>
              </ul>
            </div>
            <div>
              <h4 className="text-gray-900 font-semibold mb-4">关注我们</h4>
